    ...
    <div className={styles.App}>
      ...
      <div className={styles.form}>
        <div className={styles.box}>
          <h2>1970</h2>
          <p>
            <span>Строительство Чернобыльской атомной электростанции (ЧАЭС) </span>
        ...
        <div className={styles.box}>
          <h2>26 апреля 1986</h2>
          <h3>Катастрофа</h3>
          <h4>на Чернобыльской АЭС, Чернобыльская катастрофа —</h4>
          <p>
      ...
      <h1 className={styles.title}>Как это было?</h1>

      <div className={styles.form}>
        <div className={styles.box}>
          <h2>25 апреля 1986</h2>
          <p>
      ...
      <h1 className={styles.title}>Причины аварии</h1>
